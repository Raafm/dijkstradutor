...
countries: Brazil (BR), Germany (DE), Russia (RU), India (IN) and 
United States (US). The subgraph containing these countries and some of
these languages will be used in an animation for illustration purposes.
"""

from Nodes.data_relations.data_relations import initials_num, num_initials, initials_name
...
induced_adj = {br_num: [], de_num: [], ru_num: [], in_num: [], us_num: []}
